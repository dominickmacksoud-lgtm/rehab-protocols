...
Paste the PDF URLs into the chat with Claude. Claude downloads the PDFs and extracts plain text via pdfplumber, then writes an append script. Run the append script, then regenerate (see below).
